...
MACS = {
    ...
    'hmac-sha1-96-etm@openssh.com': [ WEAK_HASH, SMALL_TAG_SIZE ],
    'hmac-sha1-96':                 [ WEAK_HASH, ENCRYPT_AND_MAC, SMALL_TAG_SIZE ],
    'hmac-md5-etm@openssh.com':     WEAK_HASH,
    'hmac-md5-96-etm@openssh.com':  [ WEAK_HASH, SMALL_TAG_SIZE ],
    'hmac-md5':                     [ WEAK_HASH, ENCRYPT_AND_MAC ],
    'hmac-md5-96':                  [ WEAK_HASH, ENCRYPT_AND_MAC, SMALL_TAG_SIZE ],
}
